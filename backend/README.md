...
## Project Structure
    ...
    ├── testapiautoconnect_109623  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_109623`
...
2. Clone this repo and `cd testapiautoconnect_109623`
